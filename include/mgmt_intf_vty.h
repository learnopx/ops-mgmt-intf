...
#define MGMT_INTF_MODE_IP_STR         \
"Set the mode for management interface (static/dhcp) (Default:dhcp)\n"
#define MGMT_INTF_DHCP_STR            "Set the mode as dhcp\n"
#define MGMT_INTF_STATIC_STR          "Set the mode as static\n"
#define MGMT_INTF_DEFAULT_GW_STR      \
"Configure the Default gateway address (IPv4 and IPv6)\n"
#define MGMT_INTF_DNS_STR             "Configure the nameserver\n"
#define MGMT_INTF_DNS_1_STR           \
"Configure the primary nameserver IPv4 address\n"
#define MGMT_INTF_DNS_2_STR           \
"Configure the secondary nameserver IPv4 address\n"
#define MGMT_INTF_DNS_1_IPV6_STR      \
"Configure the primary nameserver IPv6 address\n"
#define MGMT_INTF_DNS_2_IPV6_STR      \
"Configure the secondary nameserver IPv6 address\n"
...
#define OVSDB_MODE_ERROR              \
"Configurations not allowed in dhcp mode."
#define OVSDB_DNS_DEPENDENCY_ERROR    \
"Deletion not allowed. Secondary Nameserver present."
